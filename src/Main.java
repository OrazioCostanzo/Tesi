...
SuffixArray.setFilter("");
       ...
       try(PrintWriter writer = new PrintWriter("PROVA.txt")){
            for(int i=0 ; i<n ; i++) writer.println("LCP INDEX: " + s.getLcpElement(i) +" SA INDEX:"  + s.getSaElement(i) + " TA INDEX: " + s.getIsaElement(i) + " CARATTERE SINISTRO: " + s.getLCAElement(i) + " CARATTERE DESTRO: " + s.getRCAElement(i) + " SUFFISSO:" +  s.getText().substring(s.getSaElement(i)));
       ...
       int[]e =  s.getStrFre("ABC");
           System.out.println("NUMERO DI OCCORRENZE: " + e[0]  + " INIZIO: " +  e[1]  +  " FINE: " + e[2]);
