...
public class FileManager {
    ...
    public static void write(List<String> list , File file, String header){
    ...
    public static void write(Map<String,Long> map , File file){
    ...
    public static void write(Map<String,Long> map , File file, String header) {
        List<String> list = map.keySet().stream().sorted().collect(Collectors.mapping(key -> key + ":" + map.get(key), Collectors.toList()));
        try (BufferedWriter out = new BufferedWriter(new FileWriter(file))) {
            out.write(header + "\n" + "\n");
            for (String s : list)
